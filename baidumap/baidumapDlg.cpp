...
void CbaidumapDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_EDIT_LNG, m_edit_lng);
	DDX_Control(pDX, IDC_EDIT_LAT, m_edit_lat);
	DDX_Text(pDX, IDC_EDIT_LNG, m_lng);
...
BOOL CbaidumapDlg::OnInitDialog()
{
	...
	m_webbrowser.Navigate(_T("file:///D:/Pei/Documents/Visual Studio 2013/Projects/baidumap/baidumap/geodemo.htm"), NULL, NULL, NULL, NULL);
...
void CbaidumapDlg::OnBnClickedButton1()
{
	// TODO:  在此添加控件通知处理程序代码
	UpdateData(TRUE);
	m_webpage.CallJScript(_T("gotoLocation"), m_lng, m_lat);
}
